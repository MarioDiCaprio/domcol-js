...
const Layout: React.FC<{ children: ReactNode }> = ({ children }) => {
    return (
        <div className="fixed w-full h-full flex justify-center items-center">
            <div className="w-full max-w-[800px] flex border border-zinc-200 rounded shadow-xl">
                
                <div className="w-1/2 p-5 flex flex-col justify-center gap-10">
                ...
                <div className="w-1/2 p-5 flex flex-col justify-center gap-3 bg-gradient-to-br from-indigo-400 to-indigo-600">
                    { children }
                </div>
